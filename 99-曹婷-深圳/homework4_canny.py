# -*- coding: utf-8 -*-
"""
Created on Mon Jul 18 11:41:01 2022
...
if __name__ == '__main__':
    ...
    # 1、高斯平滑
    img_new = gauss_filter(img)
 
    # 2、求梯度。以下两个是滤波求梯度用的sobel矩阵（检测图像中的水平、垂直和对角边缘）
    img_tidu,angle = gradient_step(img_new)
    
    # 3、非极大值抑制
    img_yizhi = yizhi(img_tidu)
    
    # 4、双阈值检测，连接边缘。遍历所有一定是边的点,查看8邻域是否存在有可能是边的点，进栈
    threshold_yizhi = threshold_yizhi(img_yizhi)
